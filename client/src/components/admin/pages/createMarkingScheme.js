...
import "../css/createMarkingScheme.css";
...
function CreateMarkingScheme() {
    ...
    const [tempMarksList, setTempMarksList] = useState([mark]);
        ...
        await Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                await axios({
                    ...
                    .then(async (res) => {
                        await saveMarkingDistributions(res.data.markingScheme._id);
                    })
                    .catch(async (err) => {
    ...
    async function saveMarkingDistributions(marking_scheme_id) {
        marksList.map(async (mark, index) => {
            ...
            await axios({
                url: "http://localhost:8080/api/markingDistribution",
                method: "POST",
                data,
                headers: {
                    Authorization: "Bearer " + getTokenFromLocalStorage(),
        ...
        await showAlerts(1, "Marking Scheme added Successfully!");
    ...
    return (
        <div className="create-marking-scheme">
            <div className="top-div mb-4 shadow">
                ...
                <div className="profile-header">
                    <h1 className="profile-name">Create a Marking Scheme</h1>
                </div>
            </div>
                ...
                <div className="col">
                    <form onSubmit={saveMarkingScheme}>
                        ...
                        <div className="mt-4 mb-4">
                            ...
                            <button
                                type="submit"
                                className="btn form-custom-btn save-custom-btn"
                            >
                                Save
                            </button>
                        </div>
